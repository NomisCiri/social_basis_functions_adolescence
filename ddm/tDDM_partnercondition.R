###This script fits a tDDM to the partner condition data
...
want = c("DEoptim", "Rcpp", "plyr", "parallel", "BH", "tidyverse","here")
...
dataBeh <- filter(dataBeh, self_partner == 2)
...
#create secondary basis functions (for partners)
dataBeh$secBF <- 0.5*dataBeh$P - 0.5*dataBeh$S - 0.5*dataBeh$Or + 0.5*dataBeh$Oi#dataBeh$irrelevant #0.5*dataBeh$P - 0.5*dataBeh$S - 0.5*dataBeh$Or + 0.5*dataBeh$Oi
